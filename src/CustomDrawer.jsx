...
const routeGroups = [
  {
    ...
    routes: [
      ...
      {
        to: "/familiaFormulario.jsx",
        label: "Integrante",
        icon: <GroupIcon />,
      },
      {
        to: "/BusquedaFamilia.jsx",
        label: "Buscar Familia",
        icon: <SearchIcon />,
      },
      {
        to: "/formularioIntegrantes.jsx",
        label: "Formulario Integrantes",
        icon: <GroupIcon />,
      },
    ],
  },
  {
    ...
    routes: [
      {
        to: "/registroSuministros.jsx",
        label: "Registrar Suministros",
        icon: <InventoryIcon />,
      },
      {
        to: "/registrarConsumibles.jsx",
        label: "Consumibles",
        icon: <LocalDiningIcon />,
      },
      { to: "/listaProducto.jsx", label: "Lista Producto", icon: <ListIcon /> },
      {
        to: "/ajusteInventario.jsx",
        label: "Ajuste Inventario",
        icon: <WarehouseIcon />,
      },
      {
        to: "/asignacionRecursos.jsx",
        label: "Asignación Recursos",
        icon: <InventoryIcon />,
      },
      {
        to: "/abarrotesMenuPrincipal",
  ...
  },
  {
    ...
    routes: [
      {
        to: "/registroAlbergue.jsx",
        label: "Registrar Albergue",
        icon: <HotelIcon />,
      },
      { to: "/listaAlbergue.jsx", label: "Lista Albergue", icon: <ListIcon /> },
      {
        to: "/busquedaAlbergue.jsx",
        label: "Buscar Albergue",
        icon: <SearchIcon />,
      },
      {
        to: "/ActualizarAlbergue.jsx",
        label: "Actualizar Albergue",
        icon: <BusinessIcon />,
      },
    ],
  },
