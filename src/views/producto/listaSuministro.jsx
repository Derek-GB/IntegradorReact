...
import { useListaSuministro } from '../../hooks/Producto/useListaSuministro.js';
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row gap-6 mt-8">
            <div className="flex-1 flex gap-4">
              <SubmitButton type="submit" width="w-full" loading={loading} color='text-black'>
                Actualizar
              </SubmitButton>
              <SubmitButton
                type="button"
...
export default ListaSuministro;
